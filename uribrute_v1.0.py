...
print "# Give the proper URI which will contain only the Username and Password fields of the web service. Usually /login.php after the main web page name works...But still, you should have proper knowledge"
  
uri = str(raw_input("# Enter URI : "))  
